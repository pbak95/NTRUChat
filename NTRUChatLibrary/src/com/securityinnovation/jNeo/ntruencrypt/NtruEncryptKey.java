...
public class NtruEncryptKey
{
        ...
        throws ParamSetNotSupportedException
    {
    	...
    	int print_size = keyParams.N;
        System.out.println("Params: N="+keyParams.N+" p="+keyParams.p+" q="+keyParams.q);
        ...
        while (!fIsInvertible)
        {
            ...
            System.out.print("F random trinomial: ");
            for(int i=0;i<print_size;i++) {
            	System.out.print(F.p[i]+" ");
            }
            System.out.println("\n");
            ...
            System.out.print("f^-1 mod q: ");
            for(int i=0;i<print_size;i++) {
            	System.out.print(fInv.p[i]+" ");
            }
            System.out.println("\n");
        ...
        System.out.print("h=f^-1*g*p mod q: ");
        for(int i=0;i<print_size;i++) {
        	System.out.print(h.p[i]+" ");
        }
        System.out.println("\n");
